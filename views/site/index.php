                ...
                <div class="card">
                  ...
                  <div class="table-responsive">
                    <table class="table card-table table-striped table-vcenter">
                      ...
                      <tbody>
                        <tr>
                          <td class="w-1"><span class="avatar" style="background-image: url(./images/faces/male/9.jpg)"></span></td>
                        ...
                        <tr>
                          <td><span class="avatar" style="background-image: url(./images/faces/female/1.jpg)"></span></td>
                        ...
                        <tr>
                          <td><span class="avatar" style="background-image: url(./images/faces/male/4.jpg)"></span></td>
                          <td>Bobby Knight</td>
                        ...
                        <tr>
                          <td><span class="avatar" style="background-image: url(./images/faces/female/11.jpg)"></span></td>
                          <td>Sharon Wells</td>
                          <td>Fixes #625</td>
            ...
            <div class="row row-cards row-deck">
              <div class="col-lg-6">
                <div class="card card-aside">
                  <a href="#" class="card-aside-column" style="background-image: url(./images/photos/david-klaasen-54203-500.jpg)"></a>
              ...
              <div class="col-lg-6">
                <div class="card card-aside">
                  <a href="#" class="card-aside-column" style="background-image: url(./images/photos/david-marcu-114194-500.jpg)"></a>
                  <div class="card-body d-flex flex-column">
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">
                            <div class="avatar d-block" style="background-image: url(images/faces/female/26.jpg)">
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar d-block" style="background-image: url(images/faces/female/21.jpg)">
                              <span class="avatar-status bg-green"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar d-block" style="background-image: url(images/faces/female/4.jpg)">
                              <span class="avatar-status bg-green"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar d-block" style="background-image: url(images/faces/female/27.jpg)">
                              <span class="avatar-status bg-green"></span>
                            </div>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td class="text-center">
                            <div class="avatar d-block" style="background-image: url(images/faces/male/20.jpg)">
                              <span class="avatar-status bg-green"></span>
                            </div>
                          </td>
                          <td>
                  ...
                  <div class="card-body o-auto" style="height: 15rem">
                    <ul class="list-unstyled list-separated">
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(images/faces/female/21.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(images/faces/female/29.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(images/faces/female/2.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
                      ...
                      <li class="list-separated-item">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="avatar avatar-md d-block" style="background-image: url(images/faces/female/11.jpg)"></span>
                          </div>
                          <div class="col">
                            <div>
